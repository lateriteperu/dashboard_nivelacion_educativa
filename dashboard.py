...
if df_raw is not None:
    ...
    with tab1:
        ...
        if not df_filtered.empty:
            ...
            fig_asist = px.bar(df_asistencia_diaria, x='Date', y='Pct_Asistencia', color='Grado', barmode='group', text_auto='.1f', title="Porcentaje de estudiantes asistentes (%)", hover_data=['Asistencia_Absoluta', 'Alumnos'], # <--- Solo agregas esta línea
